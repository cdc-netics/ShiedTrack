...
export class FindingTemplate {
  ...
  @ApiProperty({
    example: "Implementar prepared statements y validación de entrada...",
  ...
  @ApiProperty({
    example: ["sql", "injection", "database", "cwe-89"],
  ...
  @ApiProperty({
    ...
    description: "ID del tenant (si aplica)",
  })
  ...
  @ApiProperty({
    example: 42,
    description: "Número de veces que se ha aplicado esta plantilla",
  })
  @Prop({ default: 0 })
  usageCount: number;
...
export const FindingTemplateSchema =
  SchemaFactory.createForClass(FindingTemplate);
